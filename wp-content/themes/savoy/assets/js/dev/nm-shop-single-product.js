(function($) {
	...
	$.extend($.nmTheme, {
		...
		singleProduct_init: function() {
            ...
            if (self.$productWrap.hasClass('layout-scrolling')) {
		...
		singleProductVariations: function() {
            ...
            $variationsForm = ($variationsForm.length) ? $variationsForm : $('form.variations_form'); // Some plugins remove the custom "#nm-variations-form" id
