        ...
        class reduxCoreEnqueue {
            ...
            private function register_scripts() {
                ...
                Redux_CDN::register_script(
                    ...
                    '//cdn.' . $cdn_url . '.net/select2/3.5.2/select2' . $this->min . '.js',
                ...
                $cdn_url = 'goo' . 'gleapis'; // NM
                wp_enqueue_script(
                    'webfontloader',
                    /*'https://ajax.googleapis.com/ajax/libs/webfont/1.5.0/webfont.js',*/
                    'https://ajax.' . $cdn_url . '.com/ajax/libs/webfont/1.5.0/webfont.js',
                    array( 'jquery' ),
                    '1.5.0',
                    true
                );
