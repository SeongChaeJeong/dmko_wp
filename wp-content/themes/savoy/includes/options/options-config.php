<?php
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				...
				'subtitle'	=> __( 'Include the Font Awesome icon library.', 'nm-framework-admin' ),
				'default'	=> 0,
				'on' 		=> 'Enable',
				'off' 		=> 'Disable'
			),
            array(
				...
				'subtitle'	=> __( 'Select the Font Awesome version.', 'nm-framework-admin' ),
				'options'	=> array( '5' => '5.6.3 (Font Awesome CDN)', '4' => '4.7.0 (Bootstrap CDN)' ),
				'default'	=> '4',
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				'id'		=> 'product_action_link_layout',
				'type'		=> 'select',
				'title'		=> __( 'Action Link - Layout', 'nm-framework-admin' ),
