...
function nm_page_meta_box_register() {
    ...
    add_meta_box(
        ...
        __( 'Header Transparency', 'nm-framework' ),
        ...
        <div>
            <label for="nm_page_header_transparency">
                <select id="nm_page_header_transparency" name="nm_page_header_transparency" rows="6">
                    <option value="">' . esc_html__( 'Disabled', 'nm-framework' ) . '</option>
                    <option value="light" ' . selected( $header_transparency, 'light', false ) . '>' . esc_html__( 'Light', 'nm-framework' ) . '</option>
                    <option value="dark" ' . selected( $header_transparency, 'dark', false ) . '>' . esc_html__( 'Dark', 'nm-framework' ) . '</option>
                </select>
                <p class="howto">' . __( 'Select header-transparency for this page', 'nm-framework' ) . '</p>
            </label>
        </div>';
}
