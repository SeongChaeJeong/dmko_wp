<?php
	...
	// Note: The "vc_remove_element()" function removes the "contact form 7" shortcode: add_action( 'vc_after_set_mode', 'nm_vc_remove_plugin_elements', 100 );*/
	...
	vc_add_param( 'vc_row', array(
		'type' 			=> 'textfield',
		'heading' 		=> __( 'Maximum Width', 'nm-framework-admin' ),
		'param_name' 	=> 'max_width',
		'value' 		=> '',
		'description'	=> __( 'Optional: Enter a maximum width (numbers only).', 'nm-framework-admin' ),
		'weight'		=> 1
	) );
	vc_add_param( 'vc_row', array(
		'type' 			=> 'textfield',
		'heading' 		=> __( 'Minimum Height', 'nm-framework-admin' ),
		'param_name' 	=> 'min_height',
		'value' 		=> '',
		'description'	=> __( 'Optional: Enter a minimum height (numbers only).', 'nm-framework-admin' ),
		'weight'		=> 1
	) );
    ...
    vc_add_param( 'vc_separator', array(
		...
		'holder' 		=> 'div',
		'value' 		=> '',
		'description'	=> __( 'Separator title.', 'nm-framework-admin' ),
		'weight'		=> 1
	) );
	vc_add_param( 'vc_separator', array(
		'type' 			=> 'dropdown',
	...
	vc_add_param( 'vc_separator', array(
		'type' 			=> 'dropdown',
		'heading' 		=> __( 'Title position', 'nm-framework-admin' ),
		'param_name'	=> 'title_align',
		'value' 		=> array(
			__( 'Align center', 'nm-framework-admin' )	=> 'separator_align_center',
			__( 'Align left', 'nm-framework-admin' )	=> 'separator_align_left',
			__( 'Align right', 'nm-framework-admin' )	=> "separator_align_right"
		),
		'description'	=> __( 'Select title location.', 'nm-framework-admin' ),
		'weight'		=> 1
	) );
    vc_add_param( 'vc_separator', array(
        'type' 			=> 'dropdown',
	...
	vc_add_param( 'vc_separator', array(
		'type' 			=> 'colorpicker',
		'heading' 		=> __( 'Custom Border Color', 'nm-framework-admin' ),
		'param_name' 	=> 'accent_color',
		'description'	=> __( 'Select border color for your element.', 'nm-framework-admin' ),
		'weight'		=> 1
	) );
	...
	vc_add_param( 'vc_message', array(
		'type' 			=> 'dropdown',
		'heading' 		=> __( 'Message Box Presets', 'nm-framework-admin' ),
		'param_name'	=> 'color',
		'value' 		=> array(
			'Information'	=> 'info',
			'Warning'		=> 'warning',
	...
	function nm_vc_single_image_param_onclick() {
		...
		$param['value'] = array(
			__( 'None', 'nm-framework-admin' ) => '',
			__( 'Link to large image', 'nm-framework-admin' ) => 'img_link_large',
			__( 'Open custom link', 'nm-framework-admin' ) => 'custom_link'
		);
