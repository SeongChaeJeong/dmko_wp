...
function nm_product_details_meta_box_register() {
    ...
    add_meta_box(
        'nm-product-layout',
        __( 'Product Layout', 'nm-framework-admin' ),
        ...
        <div>
            <label for="nm_product_layout">
                <select id="nm_product_layout" name="nm_product_layout" rows="6">
                    ...
                    <option value="scrolling" ' . selected( $selected_value, 'scrolling', false ) . '>Scrolling</option>
                </select>
                <p class="howto">' . __( 'Select product layout', 'nm-framework-admin' ) . '</p>
            </label>
        </div>';
}
