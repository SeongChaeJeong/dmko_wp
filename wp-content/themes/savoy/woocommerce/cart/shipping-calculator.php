 ...
 * @version 3.5.0
 NM: Modified (Added "border" class to button) */
...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button border"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p>
