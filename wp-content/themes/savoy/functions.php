	...
	function nm_styles() {
		...
		if ( $nm_theme_options['font_awesome'] ) {
            if ( $nm_theme_options['font_awesome_version'] == '4' ) {
                ...
                wp_enqueue_style( 'font-awesome', '//use.fontawesome.com/releases/v5.6.3/css/all.css', array(), '5.6.3', 'all' );
            }
		}
	...
	function nm_scripts() {
		if ( ! is_admin() ) {
            ...
            $local_js_vars = array(
                ...
                // Remove - Layout can be set for individual products: 'productLayout'             => esc_attr( $nm_theme_options['product_layout'] ),
